  ...
  return (
    <div className="overflow-x-hidden">
      <div className='w-full h-[170px] flex items-center'>
        <h2 className='underline font-extrabold decoration-amber-500 decoration-4 text-[#003b6f] mx-auto text-2xl md:text-3xl shadow-2xl'>Careers</h2>
      </div>

      <section className="bg-white shadow-xl hover:shadow-2xl rounded-lg p-8 md:p-12 max-w-2xl my-12 text-center border-t-4 border-l-4 border-[#3e86c4] hover:cursor-pointer mx-auto">
