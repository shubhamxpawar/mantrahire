...
export const HeroSection = () => {
    ...
    return (
        <section className="w-full md:aspect-[2.5/1] aspect-[2/1] min-h-[150px] flex items-center bg-center bg-cover bg-no-repeat pt-40 pb-32 md:pb-0 relative" style={{backgroundImage : `url(${bglink})`}}>
