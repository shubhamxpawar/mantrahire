...
export const HeroSection = () => {
    ...
    return (
        <section className="w-full md:aspect-[2.5/1] aspect-[2/1] min-h-[150px] flex items-center bg-center bg-cover bg-no-repeat pt-50" style={{backgroundImage : `url(${bglink})`}} loading="lazy">
            <div className="bg-opacity-40 w-full h-full flex items-center px-20 md:px-30">
                <div className="max-w-2xl text-white space-y-6 my-auto">
                    <h1 className="M-font text-lg sm:text-3xl md:text-5xl font-bold leading-tight">Hiring with Purpose, Powered by Mantra </h1>
