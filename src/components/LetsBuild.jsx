...
export const LetsBuildSection = () => {
    ...
    return (
        <section className="w-full py-6 mx-auto md:px-30 bg-white flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="md:w-1/2 space-y-6 ml-8 md:ml-0 my-10">
                <h2 className="text-[#015eae] text-2xl md:text-3xl font-bold">Let's Build Better Together</h2>
                <p className="text-gray-700 text-base md:text-lg">If you're looking for an HR partner who truly listens, genuinely cares, and brings a blend of <span className="underline decoration-3 font-semibold decoration-[#3e86c4] inline cursor-default">tech, empathy, and ethics</span> — you're in the right place.</p>
