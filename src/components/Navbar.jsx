  ...
  return (
    <nav className="flex flex-wrap items-center justify-between px-4 md:px-8 py-4 shadow-md bg-white border-b-5 border-[#3e86c4] w-full z-50 fixed">
      ...
      <div className="mt-4 md:mt-0 hidden sm:flex">
        <NavLink to="/contact" className=" bg-amber-600 hover:bg-amber-700 text-white px-4 sm:px-5 py-2 rounded-md font-semibold transition text-sm sm:text-base whitespace-nowrap">Contact us</NavLink>
      </div>
    </nav>
  );
};
